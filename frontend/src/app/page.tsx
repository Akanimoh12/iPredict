...
const FEATURES = [
  {
    ...
    desc: "Bitcoin-secured finality via Stacks",
  },
  {
    icon: FiGift,
  ...
  },
  {
    icon: FiShield,
    title: "Fully Onchain",
    desc: "All bets, payouts, and rankings stored on Clarity smart contracts",
  },
];

const STEPS = [
  { num: "01", title: "Connect Wallet", desc: "Connect Leather or Xverse. No signup needed." },
  { num: "02", title: "Pick a Market", desc: "Browse active predictions. Crypto, sports, events." },
  { num: "03", title: "Bet YES or NO", desc: "Stake STX on your prediction. See live odds." },
...
const ROADMAP = [
  ...
  { date: "Q4 2026", title: "Scale", desc: "Mainnet launch, mobile app, sBTC integration" },
];
      ...
      <section className="relative overflow-hidden pt-20 pb-24 sm:pt-28 sm:pb-32">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-500/10 border border-primary-500/20 text-sm text-primary-400 mb-6">
            ...
            Live on Stacks Testnet | Low 2% fee
          </div>
          ...
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-8">
            Decentralized prediction market on Stacks. Bitcoin-secured finality. Low fees.
          </p>
