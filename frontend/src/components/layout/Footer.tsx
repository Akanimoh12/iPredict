...
const RESOURCE_LINKS = [
  { href: "https://docs.stacks.co", label: "Docs", external: true },
  { href: "https://github.com/Akanimoh12/iPredict.git", label: "GitHub", external: true },
];
...
const SOCIAL_LINKS = [
  ...
  { href: "https://t.me/ipredicthq", label: "Telegram", icon: FiMessageCircle },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="border-t border-surface-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-slate-600">
            &copy; {new Date().getFullYear()} iPredict. Built on Stacks.
          </p>
        </div>
      </div>
    </footer>
