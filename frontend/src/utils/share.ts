...
const BASE_URL = "https://ipredict-stacks.vercel.app";
 ...
 *
 * Example output:
 *   "I just bet 100 STX that Will ETH flip BTC? on iPredict!
 *    Think I'm wrong? 👉 https://ipredict-stacks.vercel.app/markets/1?ref=ST1PQ..."
 */
export function buildShareText(
  ...
  return `I just bet ${amount} STX ${side} on "${question}" on iPredict! Think I'm wrong? 👉 ${marketUrl}`;
}
